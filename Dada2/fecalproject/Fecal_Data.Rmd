...
```{r}
# Merge multiple runs 
st1 <- readRDS("T:/DCEG/CGF/Laboratory/Projects/MR-0084/NP0084-MB5/QC Data/qiime/Combo with NP0084-MB4/04_23_18_input_combo/Run1/Output/seqtabrun1.rds")
st2 <- readRDS("T:/DCEG/CGF/Laboratory/Projects/MR-0084/NP0084-MB5/QC Data/qiime/Combo with NP0084-MB4/04_23_18_input_combo/Run2/Output/seqtabrun2.rds")
st3 <- readRDS("T:/DCEG/CGF/Laboratory/Projects/MR-0084/NP0084-MB5/QC Data/qiime/Combo with NP0084-MB4/04_23_18_input_combo/Run3/Output/seqtabrun3.rds")
st.all <- mergeSequenceTables(st1, st2, st3)

# Remove chimeras
#seqtab <- removeBimeraDenovo(st.all, method="consensus", multithread=TRUE)
seqtab <- removeBimeraDenovo(st3, method="consensus", multithread=TRUE) ###Only run 3 used
...
taxtab <- addSpecies(seqtab, "C:/Users/sevillas2/Google Drive/My Documents/Education/George Mason University/BINF703/2018_Spring_BaranovaGillevet/Analysis/DADA2/References/silva_species_assignment_v128.fa.gz")

# Write to disk
saveRDS(seqtab, "T:/DCEG/CGF/Laboratory/Projects/MR-0084/NP0084-MB5/QC Data/qiime/Combo with NP0084-MB4/04_23_18_input_combo/Output/sextab_final_3only.rds") 
...
```{r}
taxa <- assignTaxonomy(seqtab.nochim, "C:/Users/sevillas2/Google Drive/My Documents/Education/George Mason University/BINF703/2018_Spring_BaranovaGillevet/Analysis/DADA2/References/silva_nr_v128_train_set.fa.gz", multithread=TRUE)

...
#Write file
write.csv(average_seq,"averages_seq_nephandq2.csv")
```
...
#Write file
write.csv(average_seq,"averages_seq_200zymo_nephandq2.csv")
```
...
#Write file
write.csv(average_seq,"averages_seq_2000zymo_nephandq2.csv")
...
write.csv(average_seq,"averages_seq_nephandq2_unexp.csv")
...
#Write file
write.csv(average_seq,"averages_seq_nephandq2_unexp_complete.csv")
```

...
write.csv(genus_otuabund_sample,"genus_otuabund_seq_q2_sample.csv")
```
...
#Output to text file
write.csv(genus_otuabund_control,"genus_otuabund_seq_q2_control.csv")
```
...
#Output to text file
write.csv(genus_percent,"genus_outabund_seq_q2.csv")
```
...
#Output file
write.csv(temp,"genus_otuabund_seq_q2_obsVSexp.csv")
...
head(temp2)
write.csv(temp2,"genus_otuabund_seq_q2_obsVexp_tab.csv")
...
write.csv(temp,"genus_otuabund_seq_q2_other.csv")
colnames(temp)
head(temp)
...
head(temp2)
write.csv(temp2,"genus_otuabund_seq_q2_other_tab.csv")
```

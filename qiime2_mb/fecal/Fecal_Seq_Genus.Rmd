...
for (a in plates){
 ...
 for (b in control_types) {
  ...
  genus_otucount_seq[row_count, b] <- genus_average
  genus_otucount_seq[row_count2, b] <- genus_average
 }
...
row.names (genus_otucount_seq) <- c("PC04924_Count", "PC04924_Expected", "PC04925_Count", "PC04925_Expected", "PC07578_Count", "PC07578_Expected")  
```
...
new_colnames<- c("PC04924_OB", "PC04925_OB","PC07578_OB",
                 "PC04924_MS1000", "PC04924_MS1001","PC04924_MS1002","PC04924_MS1003", 
                 "PC04924_Seq.200", "PC04924_Seq2000",
                 "PC04925_MS1000", "PC04925_MS1001","PC04925_MS1002","PC04925_MS1003", 
                 "PC04925_Seq.200", "PC04925_Seq2000",
                 "PC07578_MS1000", "PC07578_MS1001","PC07578_MS1002","PC07578_MS1003", 
                 "PC07578_Seq.200", "PC07578_Seq2000")
...
#Output to text file
write.csv(genus_percent,"genus_outabund_seq.csv")
```

#OTU Percent - Analysis of Genus Percent Abundance Differences, expected versus observed by kit (Ext Only)
Create new genus databse with only MSA and Zymo Seq Columns
```{r}

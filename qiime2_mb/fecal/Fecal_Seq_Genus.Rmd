...
new_colnames <- c("PC04924-MSA1000_Diff", "PC04924-MSA1001_Diff", "PC04924-MSA1002_Diff",
                  ...
                  "PC04925-MSA1000_Diff", "PC04925-MSA1000_Diff", "PC04925-MSA1001_Diff",
                  "PC04925-MSA1002_Diff", "PC049254-Seq.200_Diff", "PC04925-Seq.2000_Diff",
                  "PC07578-MSA1000_Diff", "PC07578-MSA1000_Diff", "PC07578-MSA1001_Diff",
                  "PC07578-MSA1002_Diff", "PC07578-Seq.200_Diff", "PC07578-Seq.2000_Diff")
...
#Output file
write.csv(temp,"genus_otuabund_obsVSexp_seq.csv")
```

#11.OTU Percent - Not expected Genus by Control Type by Kit (Seq Only)
```{r}
#Create temp dataframe from genus_percent
colnames(temp)
temp <- genus_percent[,c(12:15,17,24:41)]
...
write.csv(temp,"genus_other_seq.csv")
```

...
write.csv(order_otuabund_sample,"order_otuabund_sample.csv")
```
...
#Output to text file
write.csv(order_otuabund_control,"order_otuabund_control.csv")
```
...
#Output to text file
write.csv(order_percent,"order_outabund_kit.csv")
```
...
#Output file
write.csv(temp,"order_otuabund_obsVSexp_ext.csv")
```
...
write.csv(temp,"order_other.csv")
```

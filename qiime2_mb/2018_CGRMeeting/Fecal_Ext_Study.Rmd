...
control_info <- subset(filtered_info,Type=='Study' | Type=="RG")
control_info <- subset(control_info,O.R=='Original')
...
write.csv(genus_otuabund_sample,"Data/genus_otuabund_ext_neph_sample.csv")
```
...
#Output to text file
write.csv(genus_otuabund_control,"Data/genus_otuabund_ext_neph_study.csv")
```
...
new_colnames<- c("Qiagen DSP Virus_OB", "Zymo MagBead DNone Kit_OB","MagAttract PowerMag Soil_OB",
                 ...
                 "Qiagen DSP Virus_OB_Study", "Qiagen DSP Virus_OB_RG",
                 "Zymo MagBead DNone Kit_OB_Study","Zymo MagBead DNone Kit_OB_RG",
                 "MagAttract PowerMag Soil_OB_Study","MagAttract PowerMag Soil_OB_RG",
                 "MagAttract PowerMag Microbiome_OB_Study","MagAttract PowerMag Microbiome_OB_RG",
                 "Qiagen QIAamp  Modified_OB_Study","Qiagen QIAamp  Modified_OB_RG")
...
#Output to text file
write.csv(genus_percent,"Data/genus_outabund_kit_study.csv")
```

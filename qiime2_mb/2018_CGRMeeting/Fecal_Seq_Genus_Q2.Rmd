...
samples_failed <- read.table("T:\\DCEG\\CGF\\TechTransfer\\Microbiome\\Extraction\\Optimization\\Fresh Fecal Optimization_2017.08\\Analysis\\Run1&2\\TaxaCounts\\samplesfailed_q2_exclusions.txt",sep="\t")
...
genus_otu <- read.csv("T:\\DCEG\\CGF\\TechTransfer\\Microbiome\\Extraction\\Optimization\\Fresh Fecal Optimization_2017.08\\Analysis\\Run1&2\\TaxaCounts\\qiime2_taxa_counts_genus_silva_exclusions.csv", row.names = 1)
...
write.csv(genus_otuabund_sample,"Data/genus_otuabund_seq_q2_sample.csv")
```
...
#Output to text file
write.csv(genus_otuabund_control,"Data/genus_otuabund_seq_q2_control.csv")
```
...
#Output to text file
write.csv(genus_percent,"Data/genus_outabund_seq_q2.csv")
```
...
#Fix bug
#genus_percent["Staphylococcus","PC07578_MSA1000"]<-0
...
#Output file
write.csv(temp,"Data/genus_otuabund_seq_q2_obsVSexp.csv")
...
head(temp2)
write.csv(temp2,"Data/genus_otuabund_seq_q2_obsVexp_tab.csv")
...
write.csv(temp,"Data/genus_otuabund_seq_q2_other.csv")
colnames(temp)
head(temp)
...
head(temp2)
write.csv(temp2,"Data/genus_otuabund_seq_q2_other_tab.csv")
```

#12 Plot graphs of expected to actual
Add slope
```{r}
###############
#MSA1000
...
#Expand the plot
temp4 <- subset(temp3,value>.05)
temp4

temp5 <- subset(temp3,value<.05)
temp5
...
ggplot(data=temp3,mapping=aes(x=Expected,y=value,color=Type,jitter(Expected,factor=1)))+
 ...
 labs(title="MSA1000-QIIME2", x="Expected Percentage", y= "Actual Percentage")+
...
temp4 <- subset(temp3,Expected>.04)
temp4

temp5 <- subset(temp3,Expected<.04)
temp5
...
ggplot(data=temp3,mapping=aes(x=Expected,y=value,color=Type,jitter(Expected,factor=1)))+
 ...
 geom_smooth(method = "lm",se=FALSE)+ #Add a smooth line
 labs(title="MSA1001-QIIME2", x="Expected Percentage", y= "Actual Percentage")+
 geom_text(mapping=aes(label=Genus))
##Uppers
ggplot(data=temp4,mapping=aes(x=Expected,y=value,color=Type,jitter(Expected,factor=1)))+
 #geom_point()+ #Can add points to graph
 geom_smooth(method = "lm",se=FALSE)+ #Add a smooth line
 labs(title="MSA1001-QIIME2-Upper", x="Expected Percentage", y= "Actual Percentage")+
 geom_text(mapping=aes(label=Genus))
##Lowers
ggplot(data=temp5,mapping=aes(x=Expected,y=value,color=Type,jitter(Expected,factor=1)))+
 #geom_point()+ #Can add points to graph
 geom_smooth(method = "lm",se=FALSE)+ #Add a smooth line
 labs(title="MSA1001-QIIME2-Lower", x="Expected Percentage", y= "Actual Percentage")+
 geom_text(mapping=aes(label=Genus))
...
#Create databases of upper and lower expected frequencies
temp4 <- subset(temp3,value>.07)
temp4

temp5 <- subset(temp3,value<.07)
temp5
...
ggplot(data=temp3,mapping=aes(x=Expected,y=value,color=Type,jitter(Expected,factor=1)))+
 #geom_line()+ #Can add points to graph
 geom_smooth(method = "lm",se=FALSE)+ #Add a smooth line
 labs(title="MSA1002-QIIME2", x="Expected Percentage", y= "Actual Percentage")+
 geom_text(mapping=aes(label=Genus))
##Uppers
ggplot(data=temp4,mapping=aes(x=Expected,y=value,color=Type,jitter(Expected,factor=1)))+
 #geom_point()+ #Can add points to graph
 geom_smooth(method = "lm",se=FALSE)+ #Add a smooth line
 labs(title="MSA1002-QIIME2-Upper", x="Expected Percentage", y= "Actual Percentage")+
 geom_text(mapping=aes(label=Genus))
##Lowers
ggplot(data=temp5,mapping=aes(x=Expected,y=value,color=Type,jitter(Expected,factor=1)))+
 #geom_point()+ #Can add points to graph
 geom_smooth(method = "lm",se=FALSE)+ #Add a smooth line
 labs(title="MSA1002-QIIME2-Lower", x="Expected Percentage", y= "Actual Percentage")+
 geom_text(mapping=aes(label=Genus))
...
ggplot(data=temp3,mapping=aes(x=Expected,y=value,color=Type,jitter(Expected,factor=1)))+
 #geom_line()+ #Can add points to graph
 geom_smooth(method = "lm",se=FALSE)+ #Add a smooth line
 labs(title="MSA1003-QIIME2", x="Expected Percentage", y= "Actual Percentage")+
 geom_text(mapping=aes(label=Genus))
##Uppers
ggplot(data=temp4,mapping=aes(x=Expected,y=value,color=Type,jitter(Expected,factor=1)))+
 #geom_point()+ #Can add points to graph
 geom_smooth(method = "lm",se=FALSE)+ #Add a smooth line
 labs(title="MSA1003-QIIME2-Upper", x="Expected Percentage", y= "Actual Percentage")+
 geom_text(mapping=aes(label=Genus))
##Lowers
ggplot(data=temp5,mapping=aes(x=Expected,y=value,color=Type,jitter(Expected,factor=1)))+
 #geom_point()+ #Can add points to graph
 geom_smooth(method = "lm",se=FALSE)+ #Add a smooth line
 labs(title="MSA1003-QIIME2-Lower", x="Expected Percentage", y= "Actual Percentage")+
 geom_text(mapping=aes(label=Genus))
...
#Create databases of upper and lower expected frequencies
temp4 <- subset(temp3,value>.15)
temp4

temp5 <- subset(temp3,value<.15)
temp5
...
ggplot(data=temp3,mapping=aes(x=Expected,y=value,color=Type,jitter(Expected,factor=1)))+
 #geom_line()+ #Can add points to graph
 geom_smooth(method = "lm",se=FALSE)+ #Add a smooth line
 labs(title="Zymo Seq 200-QIIME2", x="Expected Percentage", y= "Actual Percentage")+
 geom_text(mapping=aes(label=Genus))
ggplot(data=temp4,mapping=aes(x=Expected,y=value,color=Type,jitter(Expected,factor=1)))+
 #geom_line()+ #Can add points to graph
 geom_smooth(method = "lm",se=FALSE)+ #Add a smooth line
 labs(title="Zymo Seq 200-QIIME2-Upper", x="Expected Percentage", y= "Actual Percentage")+
 geom_text(mapping=aes(label=Genus))
ggplot(data=temp5,mapping=aes(x=Expected,y=value,color=Type,jitter(Expected,factor=1)))+
 #geom_line()+ #Can add points to graph
 geom_smooth(method = "lm",se=FALSE)+ #Add a smooth line
 labs(title="Zymo Seq 200-QIIME2_Lower", x="Expected Percentage", y= "Actual Percentage")+
 geom_text(mapping=aes(label=Genus))
###############
#SEQ2000
###############
...
ggplot(data=temp3,mapping=aes(x=Expected,y=value,color=Type,jitter(Expected,factor=1)))+
 #geom_line()+ #Can add points to graph
 geom_smooth(method = "lm",se=FALSE)+ #Add a smooth line
 labs(title="Zymo Seq 2000-QIIME2", x="Expected Percentage", y= "Actual Percentage")+
 geom_text(mapping=aes(label=Genus))
ggplot(data=temp4,mapping=aes(x=Expected,y=value,color=Type,jitter(Expected,factor=1)))+
 #geom_line()+ #Can add points to graph
 geom_smooth(method = "lm",se=FALSE)+ #Add a smooth line
 labs(title="Zymo Seq 2000-QIIME2-Upper", x="Expected Percentage", y= "Actual Percentage")+
 geom_text(mapping=aes(label=Genus))
ggplot(data=temp5,mapping=aes(x=Expected,y=value,color=Type,jitter(Expected,factor=1)))+
 #geom_line()+ #Can add points to graph
 geom_smooth(method = "lm",se=FALSE)+ #Add a smooth line
 labs(title="Zymo Seq 2000-QIIME2_Lower", x="Expected Percentage", y= "Actual Percentage")+
 geom_text(mapping=aes(label=Genus))
```
